...
export const GET = withAuth(async (
  ...
  try {
    ...
    const negado = await guardaEmpresaFiscal({ userId, companyId: nota.company_id, papelMinimo: 'membro', log: { notaTipo: 'nfe', notaId: params.id, operacao: 'consulta', endpoint: 'nfe/consultar' } })
