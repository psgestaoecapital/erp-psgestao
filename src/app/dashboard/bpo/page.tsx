...
export default function BPOPage(){
  ...
  <div style={{padding:20,maxWidth:1200,margin:"0 auto",background:BG,minHeight:"100vh"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,flexWrap:"wrap",gap:8}}>
      <div><div style={{fontSize:22,fontWeight:700,color:GOL}}>BPO Inteligente</div><div style={{fontSize:11,color:TXM}}>Central de operações • PS Gestão e Capital • v8.0</div></div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(160px, 1fr))",gap:8,marginBottom:16}}>
      {[
        ...
        {href:"/dashboard/bpo/rotinas",icon:"📋",nome:"Rotinas",desc:"Rotinas automáticas",cor:PU},
    ...
    <div style={{fontSize:10,color:TXD,textAlign:"center",marginTop:20,padding:12,background:BG2,borderRadius:8,border:`1px solid ${BD}`}}>
      PS Gestão e Capital — BPO Inteligente v8.0 | {totalClients} empresa(s)
    </div>
  </div>);
}
