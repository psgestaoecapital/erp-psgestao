...
const CONNECTORS = [
  ...
  {id:"contaazul",nome:"ContaAzul",cat:"erp",status:"ativo",cor:G,icon:"🔷",
    desc:"Gestão financeira para PMEs. API REST + Token Bearer.",
    campos:[{k:"token",l:"Token de Acesso",p:"Token Bearer do ContaAzul"}],
