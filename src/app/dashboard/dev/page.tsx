    ...
    <div style={{padding:20,maxWidth:1200,margin:"0 auto",background:BG,minHeight:"100vh"}}>
      ...
      {tab==="changelog"&&(
        <div style={{background:BG2,borderRadius:14,padding:20,border:`1px solid ${BD}`}}>
          ...
          {[
            {data:"09/04/2026",ver:"v8.0",items:["🔄 Toggle Regime Caixa/Competência","📊 Orçado vs Real nos custos com variação %","🗑️ Removido dados fictícios (SOLAR OESTE)","👑 Relatório V19 — 18 Slides CEO Edition","📥 Módulo Importar Dados (download template + upload)","💰 PS Wealth — Dashboard + Carteira + Cotações","📋 Relatório Premium com layout executivo","🏭 Deploy API automático (GitHub push)","🔒 Auditoria de segurança (14 itens verificados)","📝 Rodapé e textos atualizados (Consultoria de Investimentos)"]},
