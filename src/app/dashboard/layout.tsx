    ...
    <div style={{ minHeight: "100vh", background: "#0C0C0A" }}>
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <a href="/wealth" style={{ fontSize: 10, color: "#C6973F", textDecoration: "none", padding: "5px 12px", borderRadius: 8, border: "1px solid #C6973F30", background: "#C6973F08", fontWeight: 600 }}>💰 Wealth</a>
