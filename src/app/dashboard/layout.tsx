...
const Icon = {
  ...
  MessageCircle: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>,
...
const MENU: Record<PlanoTipo, MenuGroup[]> = {
  comercio: [
    ...
    { label: 'FINANCEIRO', items: [
      ...
      { href: '/dashboard/financeiro/fluxo-caixa', label: 'Fluxo de Caixa', icon: <Icon.DollarSign /> },
  ...
  bpo: [
    ...
    { label: 'BPO OPERADOR', items: [
      ...
      { href: '/dashboard/bpo/conversas', label: 'Conversas', icon: <Icon.MessageCircle />, badge: 'NOVO' },
