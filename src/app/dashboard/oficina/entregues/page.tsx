...
export default function EntreguesPage() {
  ...
  }, [companyId, dataIni, dataFim, busca])
  ...
  return (
    <div style={{ background: BG, minHeight: '100vh', padding: '20px 14px 44px', maxWidth: 900, margin: '0 auto', color: ESP }}>
      ...
      <p style={{ color: ESP60, fontSize: 13, marginTop: 6, marginBottom: 14 }}>Histórico do que já saiu. Custos são reais; receita/lucro aguardam o faturamento pela OS.</p>
