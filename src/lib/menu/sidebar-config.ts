...
export const SIDEBAR_GESTAO_EMPRESARIAL: SidebarModuleNode[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'dre-consolidado', label: 'DRE Consolidado', href: '/dashboard/financeiro/dre-consolidado', status: 'pronto', badge: 'Grupo', matchPaths: ['/dashboard/financeiro/dre-consolidado'] },
