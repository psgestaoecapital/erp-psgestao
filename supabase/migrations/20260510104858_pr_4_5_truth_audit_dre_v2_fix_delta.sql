-- PR 4.5 (cont): RPC v2 sem delta_absoluto (eh generated column)
...
BEGIN
  ...
  -- delta_absoluto removido (eh generated - calculado automaticamente)
  ...
  SELECT
    ...
    CASE
      ...
      WHEN c.delta_pct > 1 THEN 'Verificar transferencias/vendas-ativos em erp_receber (design contabil Tryo)'
