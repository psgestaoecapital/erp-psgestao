-- =============================================================
-- fix-import-produtos-fiscal-aceitar-texto-v1
-- =============================================================
-- Antes: st/monofasico exigiam boolean estrito.
-- Agora: aceitam boolean OU texto (ICMS-ST=SIM/NAO, PIS/COFINS=MONOFASICO/NAO).
-- Chaves aceitas:
--   st           (bool/texto) ou icms_st         (texto da planilha)
--   monofasico   (bool/texto) ou pis_cofins      (texto da planilha)
--
...
BEGIN
  ...
  LOOP
    ...
    -- ST: aceita boolean OU texto (SIM/S/1/TRUE), via 'st' ou 'icms_st'
    v_st := CASE
    ...
    -- Monofasico: aceita boolean OU texto. Quando vier 'pis_cofins' da planilha,
    -- "MONOFASICO" -> true; "NAO MONOFASICO" -> false (LIKE 'MONOF%' nao bate).
    v_mono := CASE
